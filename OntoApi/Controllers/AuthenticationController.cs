...
namespace OntoApi.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public AuthenticationController(UserManager<UserModel> userManager, IConfiguration configuration, ILogger<AuthenticationController> logger)
        {
        ...
        private ClaimsPrincipal? GetPrincipalFromExpiredToken(string token)
        {
            ...
            {
                //TODO -Пока не добавляем, так как нужно разобраться с портами внутри конфига
